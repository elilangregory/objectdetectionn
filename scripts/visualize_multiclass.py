"""
Visualize teammate's multiclass pipeline on test images.

Usage:
    cd /Users/elilangregory/Documents/NM_AI/object_detection
    venv/bin/python scripts/visualize_multiclass.py --n 25
"""
...
# Add multiclass workspace to path
import importlib.util
spec = importlib.util.spec_from_file_location(
    "submission_inference",
    "workspaces/multiclass/submission_inference.py"
)
submission_inference = importlib.util.module_from_spec(spec)
spec.loader.exec_module(submission_inference)
...
def main(args):
    ...
    pipeline = submission_inference.SubmissionPipeline(Path("workspaces/multiclass"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", default="output_test_vis_multiclass")
